...
export default function ReminderSheet({
  ...
  initialDate,              // Date (opcional) para precargar
  onClose,                  // () => void
  onSave,                   // (finalDate: Date) => void
}) {
...
const s = StyleSheet.create({
  ...
  handle: {
    width: 52, height: 5, borderRadius: 3, alignSelf: 'center',
    backgroundColor: '#ddd', marginTop: 8, marginBottom: 10,
  },
